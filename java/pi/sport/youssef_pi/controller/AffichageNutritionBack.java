...
public class AffichageNutritionBack implements Initializable {
            ...
            if (event.getClickCount() == 1) {
                try {
                    ...
                    if (selectedNutrition != null) {
                        ...
                        FXMLLoader loader = new FXMLLoader(HelloApplication.class.getResource("/pi/sport/youssef_pi/ShowNutrition.fxml"));
    ...
    private void ajouter(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/pi/sport/youssef_pi/CreateNutrition.fxml"));
            Scene scene = new Scene(root);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
