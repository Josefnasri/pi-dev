...
public class AdminController implements Initializable {
    ...
    public void openModifInterface2(ActionEvent event) {
        try {
            // Load the Modif.fxml file
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/pi/sport/youssef_pi/AffichageNutritionBack.fxml"));
            Parent root = loader.load();
    ...
    public void openModifInterface1(ActionEvent event) {
        try {
            // Load the Modif.fxml file
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/pi/sport/youssef_pi/Chart.fxml"));
            Parent root = loader.load();
